...
export const PostCard = (post: Post) => {
    ...
    <article class="flex lg:rounded-btn bg-neutral border border-black">
        ...
        <!-- Dig Btn section-->
        <div class="flex-none flex flex-col justify-between w-16 lg:w-24 gap-2 pr-1 lg:pr-2">
            <button class="grow btn btn-warning lg:btn-lg p-2 rounded-none rounded-br-md lg:rounded-tl-btn flex flex-col">
                <p>999</p> 
                <p>Digs</p> 
            </button>

            <button class="btn  btn-xs lg:btn-md rounded-b-none rounded-l-none "> 
        ...
        <div class="grow flex flex-col">
            <div class="flex">
                ...
                <div class="flex flex-col justify-between w-full">
                    ...
                    <p class="lg:font-medium line-clamp-2 px-2 lg:pb-2 text-sm lg:text-lg">
                    ...
                    <div class="flex items-center justify-end lg:justify-between gap-0 lg:gap-2 pl-2">
                        <button class=" hidden btn  btn-xs lg:btn-md lg:inline-flex items-center rounded-b-none">
                            <div class="avatar">
                        ...
                        <div class="flex lg:gap-2">
                            ...
                            <button class="btn  btn-xs lg:btn-md rounded-none">
                                <span class="hidden lg:block">99</span> 
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-4 w-4">
                            ...
                            <button class="btn  btn-xs lg:btn-md btn-primary rounded-none lg:rounded-br-md w-16 lg:w-24 p-0">
                                <span>99</span>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
