                ...
                <div class="flex flex-col justify-between w-full pt-2 lg:pt-4">
                    ...
                    <div class="flex items-center justify-between gap-0 lg:gap-4 pl-2 lg:pl-4">
                        ...
                        <div class="flex items-end">
                            ...
                            <button class="btn btn-xs lg:btn-md ml-1 lg:ml-2 btn-error rounded-none rounded-br-md rounded-tl-btn w-16 lg:w-36 p-0 text-neutral-content">
                                <span>9.9k</span>
