                    ...
                    <div class="flex flex-col gap-2 px-4 py-4 lg:px-6 ">
                        ...
                        >
                            ...
                            <p class="self-center line-clamp-3 font-semibold text-sm lg:text-2xl lg:leading-relaxed">
                                ...
                                <a href="/p/${post.slug}" class="link decoration-1 lg:decoration-auto">T${post.title}</a>
                            </p>
                        ...
                        <div class="card-actions flex justify-between py-2 border-b items-center">
                            ...
                            <div class="flex gap-4">
                                <a class="btn border">
                                    ...
                                    <span class="link">Tech</span>
                                </a>

    

                                <button class="link btn btn-ghost btn-xs lg:btn-md">
                                    <div class="avatar">
                        ...
                        <p class="prose prose-sm lg:prose-lg max-w-none">R${post.content}</p>
